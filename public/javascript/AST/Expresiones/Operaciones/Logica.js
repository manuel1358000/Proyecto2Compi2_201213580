            ...
            if(this.exp1!=null&&this.exp2!=null){
                ...
                if(tipo!=null){
                    if(this.operador=="||"){
                        ...
                        console.log("Error semantico: Operador no soportado para operaciones logicas");
                    }
                }else{
                    console.log("Error semantico: No se pueden operar los tipos tipo1: "+tipo1+" tipo2:"+tipo2);
                }
            }else{
                return this.valor;
            }

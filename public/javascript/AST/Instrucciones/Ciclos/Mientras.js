                        ...
                        if(this.nodos[i] instanceof Declaracion){
                            ...
                            lista_errores.push(errores_1);
                                ...
                                try{
                                    ...
                                    console.log("Error general en sim mientras declaracion");
                                }
                            ...
                            if(result_temp!=null){
                                try{
                                    ...
                                    console.log("Error general en asignacion mientras");
                                }
                            }else{   
                            }
                            ...
                            if(result_temp!=null){
                                try{
                                    ...
                                    console.log("Error general en sim en mientras declaracion arreglos");
                                }
                ...
                if(this.nodos[i] instanceof Declaracion){
                    ...
                    if(!numerico(tipo_result)){
                        ...
                        try{
                            ...
                            console.log("Error general en sim, en mientras declaracion");
                        }
                    }
                }else if(this.nodos[i] instanceof Imprimir){
                    this.nodos[i].padre=this.padre;
                        ...
                        if(result_temp.tipo=="this"){
                            ...
                            try{
                               ...
                               temp+="//empieza la asignacion variable local\n";
                                ...
                                console.log("Error general en sim, mientrasasignacion");
                            }
                        }
                    }else{   
                    }
                    ...
                    if(result_temp!=null){
                        try{
                            ...
                            console.log("Error general en mientras declaracionarreglos");
                        }                    
                    }else{
                        alert("Error Semantico, en la operacion declaracion arreglos");
                        var errores_1=new Errores("Semantico","error en la operacion declaracion arreglos",0,0);

                    ...
                    if(this.nodos[i] instanceof Declaracion){
                        ...
                        if(!numerico(tipo_result)){
                            ...
                            try{
                                ...
                                console.log("Error General en si, declaracion");
                            }
                        ...
                        if(result_temp!=null){
                            try{
                                ...
                                console.log("Error general si asignacion");
                            }
                        ...
                        if(result_temp!=null){
                            try{
                                ...
                                console.log("error general en declaracion arreglos si");
                            }
                        }else{
